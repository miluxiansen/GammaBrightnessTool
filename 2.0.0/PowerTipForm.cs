...
public sealed class PowerTipForm : Form
{
    ...
    private Rectangle GetWorkingArea(Rectangle pt)
    {
        ...
        // Fallback: scale the WinForms logical working area by our DPI.
        float scale = DeviceDpi / 96.0f;
        var wa = Screen.FromRectangle(pt).WorkingArea;
        return new Rectangle(
            (int)(wa.Left * scale), (int)(wa.Top * scale),
            (int)(wa.Width * scale), (int)(wa.Height * scale));
    }
