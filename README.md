...
| 3.1.0 | 添加基础设置窗口 + 深色主题 | — | — | — |
| 3.0.0 | 亮度调节的基础可用版本 | [3.0.0/](3.0.0/README.md) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.0.0/GammaBrightnessTool_Setup_v3.0.0.exe) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.0.0/GammaBrightnessTool-Portable-v3.0.0.zip) |
