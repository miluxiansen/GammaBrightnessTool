...
|---------|---------------|--------|-----------|----------|
| **3.7.0 (Latest)** | Per-display app whitelist & pause | [3.7.0/](3.7.0/README.md) | [Download](https://github.com/miluxiansen/GammaBrightnessTool/releases/download/v3.7.0/GammaBrightnessTool_Setup_v3.7.0.exe) | [Download](https://github.com/miluxiansen/GammaBrightnessTool/releases/download/v3.7.0/GammaBrightnessTool_Portable_v3.7.0.zip) |
...
| 3.3.0 | Color temperature adjustment | [3.3.0/](early-versions/3.3.0/README.md) | [Download](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.3.0/GammaBrightnessTool_Setup.exe) | [Download](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.3.0/GammaBrightnessTool-Portable-v3.3.0.zip) |
| 3.2.0 | Global hotkeys | [3.2.0/](early-versions/3.2.0/README.md) | [Download](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.2.0/GammaBrightnessTool_Setup.exe) | [Download](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.2.0/GammaBrightnessTool-Portable-v3.2.0.zip) |
| 3.1.0 | Basic settings window + dark theme | — | — | — |
| 3.0.0 | Base version for brightness adjustment | [3.0.0/](early-versions/3.0.0/README.md) | [Download](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.0.0/GammaBrightnessTool_Setup_v3.0.0.exe) | [Download](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.0.0/GammaBrightnessTool-Portable-v3.0.0.zip) |

### ✨ Feature evolution

| Feature | 3.2.0 | 3.3.0 | 3.4.0 | 3.5.0 | 3.6.0 | 3.7.0 |
|---------|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
| Global hotkeys | ✔ | ✔ | ✔ | ✔ | ✔ | ✔ |
| Color temperature | — | ✔ | ✔ | ✔ | ✔ | ✔ |
...
| Popup / OSD opacity | — | — | — | — | ✔ | ✔ |
| App whitelist (per-display pause) | — | — | — | — | — | ✔ |
...
Latest version (3.7.0): see [3.7.0/README.md](3.7.0/README.md) for full features, usage, and build instructions.
...
MIT License © 2026 GammaBrightnessTool Contributors. See [LICENSE](LICENSE).
...
| 版本 | 发布说明 | 源码 | 安装包 | 便携版 |
|------|----------|------|--------|--------|
| **3.7.0（最新）** | 应用白名单（逐屏暂停） | [3.7.0/](3.7.0/README.md) | [下载](https://github.com/miluxiansen/GammaBrightnessTool/releases/download/v3.7.0/GammaBrightnessTool_Setup_v3.7.0.exe) | [下载](https://github.com/miluxiansen/GammaBrightnessTool/releases/download/v3.7.0/GammaBrightnessTool_Portable_v3.7.0.zip) |
...
| 3.3.0 | 色温调节 | [3.3.0/](early-versions/3.3.0/README.md) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.3.0/GammaBrightnessTool_Setup.exe) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.3.0/GammaBrightnessTool-Portable-v3.3.0.zip) |
| 3.2.0 | 全局快捷键 | [3.2.0/](early-versions/3.2.0/README.md) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.2.0/GammaBrightnessTool_Setup.exe) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.2.0/GammaBrightnessTool-Portable-v3.2.0.zip) |
| 3.1.0 | 添加基础设置窗口 + 深色主题 | — | — | — |
| 3.0.0 | 亮度调节的基础可用版本 | [3.0.0/](early-versions/3.0.0/README.md) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.0.0/GammaBrightnessTool_Setup_v3.0.0.exe) | [下载](https://gitee.com/mlxs008/gamma-brightness-tool/releases/download/v3.0.0/GammaBrightnessTool-Portable-v3.0.0.zip) |

### ✨ 功能演进

| 功能 | 3.2.0 | 3.3.0 | 3.4.0 | 3.5.0 | 3.6.0 | 3.7.0 |
|------|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
| 全局快捷键 | ✔ | ✔ | ✔ | ✔ | ✔ | ✔ |
| 色温调节 | — | ✔ | ✔ | ✔ | ✔ | ✔ |
| 时间调整（日出日落） | — | — | ✔ | ✔ | ✔ | ✔ |
...
最新版（3.7.0）：完整功能、使用方法与编译说明见 [3.7.0/README.md](3.7.0/README.md)。
...
MIT License © 2026 GammaBrightnessTool Contributors，详见 [LICENSE](LICENSE)。
