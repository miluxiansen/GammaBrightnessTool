...
public static class Localization
{
    private static readonly Dictionary<string, Dictionary<Language, string>> _strings = new()
    {
        ...
        ["TrayVisibility"] = new()
        {
            [Language.SimplifiedChinese] = "托盘图标常驻显示",
            [Language.TraditionalChinese] = "托盤圖示常駐顯示",
            [Language.English] = "Always show tray icon",
            [Language.Japanese] = "トレイアイコンを常に表示",
            [Language.Korean] = "트레이 아이콘 항상 표시",
            [Language.German] = "Taskleistensymbol immer anzeigen",
            [Language.French] = "Toujours afficher l'icône de la barre d'état",
            [Language.Spanish] = "Mostrar siempre el icono de la bandeja",
            [Language.Russian] = "Всегда показывать значок в трее",
            [Language.System] = ""
        },
        ["TrayVisibilityBlocked"] = new()
        {
            [Language.SimplifiedChinese] = "系统「隐藏的图标菜单」已关闭。为防止图标消失，本开关已锁定为开启。",
            [Language.TraditionalChinese] = "系統「隱藏的圖示選單」已關閉。為防止圖示消失，本開關已鎖定為開啟。",
            [Language.English] = "The system \"Hidden icon menu\" is off. This switch is locked to On so the icon cannot disappear.",
            [Language.Japanese] = "システムの「非表示アイコンメニュー」が無効です。アイコン消失を防ぐため、このスイッチはオンに固定されています。",
            [Language.Korean] = "시스템의 \"숨겨진 아이콘 메뉴\"가 꺼져 있습니다. 아이콘이 사라지지 않도록 이 스위치를 켜짐으로 고정했습니다.",
            [Language.German] = "Das Menü „Ausgeblendete Symbole\" ist deaktiviert. Dieser Schalter ist auf „Ein\" fixiert, damit das Symbol nicht verschwindet.",
            [Language.French] = "Le menu « Icônes masquées » est désactivé. Ce commutateur est verrouillé sur « Activé » pour éviter la disparition de l'icône.",
            [Language.Spanish] = "El menú \"Iconos ocultos\" del sistema está desactivado. Este interruptor se bloquea en Activado para evitar que el icono desaparezca.",
            [Language.Russian] = "Системное меню «Скрытые значки» отключено. Этот переключатель заблокирован во включённом состоянии, чтобы значок не исчез.",
            [Language.System] = ""
        },
        ["TrayVisibilityNotReady"] = new()
        {
            [Language.SimplifiedChinese] = "系统尚未生成本软件的托盘条目，设置未生效。请稍候重试，或在 Windows 设置中手动调整。",
            [Language.TraditionalChinese] = "系統尚未生成本軟體的托盤項目，設定未生效。請稍候重試，或在 Windows 設定中手動調整。",
            [Language.English] = "Windows has not created this app's tray entry yet, so the setting did not take effect. Retry later, or change it manually in Windows Settings.",
            [Language.Japanese] = "Windows がこのアプリのトレイ項目をまだ作成していません。設定は適用されませんでした。後で再試行するか、Windows 設定で手動で変更してください。",
            [Language.Korean] = "Windows가 이 앱의 트레이 항목을 아직 만들지 않았습니다. 설정이 적용되지 않았습니다. 나중에 다시 시도하거나 Windows 설정에서 직접 변경하세요.",
            [Language.German] = "Windows hat den Tray-Eintrag dieser App noch nicht erstellt – die Einstellung wurde nicht übernommen. Später erneut versuchen oder in den Windows-Einstellungen manuell ändern.",
            [Language.French] = "Windows n'a pas encore créé l'entrée de barre d'état de cette application ; le paramètre n'a pas été appliqué. Réessayez plus tard ou modifiez-le manuellement dans les paramètres Windows.",
            [Language.Spanish] = "Windows aún no ha creado la entrada de bandeja de esta aplicación; la configuración no se aplicó. Reintente más tarde o cámbiela manualmente en la configuración de Windows.",
            [Language.Russian] = "Windows ещё не создала запись этой программы в трее, поэтому параметр не применился. Повторите позже или измените вручную в параметрах Windows.",
            [Language.System] = ""
        },
        ["InvertScroll"] = new()
        {
        ...
        ["PopupOpacity"] = new()
        {
            [Language.SimplifiedChinese] = "左键弹窗透明度",
            [Language.TraditionalChinese] = "左鍵彈窗透明度",
            [Language.English] = "Popup opacity",
            [Language.Japanese] = "ポップアップの不透明度",
            [Language.Korean] = "팝업 불투명도",
            [Language.German] = "Popup-Deckkraft",
            [Language.French] = "Opacité de la fenêtre",
            [Language.Spanish] = "Opacidad de la ventana",
            [Language.Russian] = "Непрозрачность всплывающего окна",
            [Language.System] = ""
        },
        ["OverlayOpacity"] = new()
        {
            [Language.SimplifiedChinese] = "OSD 浮窗透明度",
            [Language.TraditionalChinese] = "OSD 浮窗透明度",
            [Language.English] = "OSD overlay opacity",
            [Language.Japanese] = "OSD の不透明度",
            [Language.Korean] = "OSD 오버레이 불투명도",
            [Language.German] = "OSD-Deckkraft",
            [Language.French] = "Opacité de l'OSD",
            [Language.Spanish] = "Opacidad de la superposición OSD",
            [Language.Russian] = "Непрозрачность OSD-оверлея",
            [Language.System] = ""
        },
        ["ExportSettings"] = new()
        {
        ...
        ["SettingsMonitors"] = new()
        {
            [Language.SimplifiedChinese] = "显示器",
            [Language.TraditionalChinese] = "顯示器",
            [Language.English] = "Monitors",
            [Language.Japanese] = "モニター",
            [Language.Korean] = "모니터",
            [Language.German] = "Monitore",
            [Language.French] = "Écrans",
            [Language.Spanish] = "Pantallas",
            [Language.Russian] = "Мониторы",
            [Language.System] = ""
        },
        // ---- 应用白名单页（设计稿 §16）----
        ["AppWhitelist"] = new()
        {
            [Language.SimplifiedChinese] = "应用白名单",
            [Language.TraditionalChinese] = "應用白名單",
            [Language.English] = "App whitelist",
            [Language.Japanese] = "アプリのホワイトリスト",
            [Language.Korean] = "앱 화이트리스트",
            [Language.German] = "App-Whitelist",
            [Language.French] = "Liste d'applications",
            [Language.Spanish] = "Lista de aplicaciones",
            [Language.Russian] = "Белый список",
            [Language.System] = ""
        },
        ["WlEnable"] = new()
        {
            [Language.SimplifiedChinese] = "启用应用白名单",
            [Language.TraditionalChinese] = "啟用應用白名單",
            [Language.English] = "Enable whitelist",
            [Language.Japanese] = "ホワイトリストを有効化",
            [Language.Korean] = "화이트리스트 사용",
            [Language.German] = "Whitelist aktivieren",
            [Language.French] = "Activer la liste",
            [Language.Spanish] = "Activar la lista",
            [Language.Russian] = "Включить белый список",
            [Language.System] = ""
        },
        // 2026-09-16 逐屏白名单：按"白名单应用窗口**完全落入**的屏幕"决定暂停哪些屏
        ["WlPerMonitor"] = new()
        {
            [Language.SimplifiedChinese] = "按显示器生效",
            [Language.TraditionalChinese] = "按螢幕生效",
            [Language.English] = "Per monitor",
            [Language.Japanese] = "モニターごとに適用",
            [Language.Korean] = "모니터별 적용",
            [Language.German] = "Pro Monitor",
            [Language.French] = "Par écran",
            [Language.Spanish] = "Por pantalla",
            [Language.Russian] = "По мониторам",
            [Language.System] = ""
        },
        ["WlPerMonitorHint"] = new()
        {
            [Language.SimplifiedChinese] = "显示器独立控制开关没开",
            [Language.TraditionalChinese] = "顯示器獨立控制開關未開啟",
            [Language.English] = "Independent monitor control is off",
            [Language.Japanese] = "モニター独立制御がオフ",
            [Language.Korean] = "모니터 독립 제어가 꺼져 있음",
            [Language.German] = "Unabhängige Monitorsteuerung ist aus",
            [Language.French] = "Contrôle indépendant désactivé",
            [Language.Spanish] = "Control independiente desactivado",
            [Language.Russian] = "Независимое управление отключено",
            [Language.System] = "",
        },
        // 2026-09-19 全屏自动暂停「按显示器生效」：文案与 WlPerMonitor 同源，便于认知迁移
        ["FsPerMonitor"] = new()
        {
            [Language.SimplifiedChinese] = "按显示器生效",
            [Language.TraditionalChinese] = "按螢幕生效",
        ...
        // 2026-09-20 通用页：全屏「按显示器生效」子开关被锁定时的原因提示
        // （原来只有一句固定的「显示器独立控制开关没开」，门控满足时仍显示 ⇒ 用户报）
        ["FsPerMonitorHintNoToggle"] = new()
        {
            [Language.SimplifiedChinese] = "全屏暂停开关没开",
            [Language.TraditionalChinese] = "全螢幕暫停開關未開啟",
            [Language.English] = "Fullscreen pause is off",
            [Language.Japanese] = "全画面一時停止がオフ",
            [Language.Korean] = "전체 화면 일시정지가 꺼져 있음",
            [Language.German] = "Vollbild-Pause ist aus",
            [Language.French] = "Pause plein écran désactivée",
            [Language.Spanish] = "Pausa en pantalla completa desactivada",
            [Language.Russian] = "Пауза в полноэкранном режиме отключена",
            [Language.System] = "",
        },

        // 2026-09-20 白名单页：「按显示器生效」子开关被锁定时的原因提示
        // （原来只有一句固定的「显示器独立控制开关没开」，门控满足时仍显示 ⇒ 用户报）
        ["WlMasterOffHint"] = new()
        {
            [Language.SimplifiedChinese] = "应用白名单开关没开",
            [Language.TraditionalChinese] = "應用程式白名單開關未開啟",
            [Language.English] = "App whitelist is off",
            [Language.Japanese] = "アプリ許可リストがオフ",
            [Language.Korean] = "앱 허용 목록이 꺼져 있음",
            [Language.German] = "App-Whitelist ist aus",
            [Language.French] = "Liste blanche désactivée",
            [Language.Spanish] = "Lista blanca desactivada",
            [Language.Russian] = "Белый список приложений отключён",
            [Language.System] = "",
        },

        // 2026-09-19 显示器页：单屏时「独立控制」总开关关闭锁定（3.6.0 遗留问题）
        ["MonSingleDisplayLock"] = new()
        {
            [Language.SimplifiedChinese] = "当前只有一台显示器",
            [Language.TraditionalChinese] = "目前只有一台顯示器",
            [Language.English] = "Only one monitor detected",
            [Language.Japanese] = "ディスプレイが 1 台のみ",
            [Language.Korean] = "모니터 1대만 감지됨",
            [Language.German] = "Nur ein Monitor erkannt",
            [Language.French] = "Un seul écran détecté",
            [Language.Spanish] = "Solo un monitor detectado",
            [Language.Russian] = "Обнаружен только один монитор",
            [Language.System] = "",
        },
        // 2026-09-19 时间调整页：滑轨被锁定时的原因提示
        ["SolarLockTempOff"] = new()
        {
            [Language.SimplifiedChinese] = "色温总开关已关闭",
            [Language.TraditionalChinese] = "色溫總開關已關閉",
            [Language.English] = "Color temperature is off",
            [Language.Japanese] = "色温がオフ",
            [Language.Korean] = "색온도 꺼짐",
            [Language.German] = "Farbtemperatur ist aus",
            [Language.French] = "Température de couleur désactivée",
            [Language.Spanish] = "Temperatura de color desactivada",
            [Language.Russian] = "Цветовая температура отключена",
            [Language.System] = "",
        },
        ["LockReasonWhitelist"] = new()
        {
            [Language.SimplifiedChinese] = "应用白名单",
            [Language.TraditionalChinese] = "應用白名單",
            [Language.English] = "App whitelist",
            ...
            [Language.Korean] = "앱 화이트리스트",
            [Language.German] = "App-Whitelist",
            [Language.French] = "Liste blanche d'applis",
            [Language.Spanish] = "Lista blanca de apps",
            [Language.Russian] = "Белый список приложений",
            [Language.System] = "",
        },
        ["LockReasonDisable"] = new()
        {
            [Language.SimplifiedChinese] = "功能停用",
            [Language.TraditionalChinese] = "功能停用",
            [Language.English] = "Feature disabled",
            [Language.Japanese] = "機能停止",
            [Language.Korean] = "기능 사용 중지",
            [Language.German] = "Funktion deaktiviert",
            [Language.French] = "Fonction désactivée",
            [Language.Spanish] = "Función desactivada",
            [Language.Russian] = "Функция отключена",
            [Language.System] = "",
        },
        ["LockReasonFullscreen"] = new()
        {
            [Language.SimplifiedChinese] = "全屏暂停",
            [Language.TraditionalChinese] = "全螢幕暫停",
            [Language.English] = "Fullscreen pause",
            [Language.Japanese] = "全画面一時停止",
            [Language.Korean] = "전체 화면 일시 중지",
            [Language.German] = "Vollbild-Pause",
            [Language.French] = "Pause plein écran",
            [Language.Spanish] = "Pausa en pantalla completa",
            [Language.Russian] = "Пауза в полноэкранном режиме",
            [Language.System] = "",
        },
        ["LockReasonTempOff"] = new()
        {
            [Language.SimplifiedChinese] = "色温开关关闭",
            [Language.TraditionalChinese] = "色溫開關關閉",
            [Language.English] = "Color temperature off",
            [Language.Japanese] = "色温オフ",
            [Language.Korean] = "색온도 꺼짐",
            [Language.German] = "Farbtemperatur aus",
            [Language.French] = "Température de couleur désactivée",
            [Language.Spanish] = "Temperatura de color desactivada",
            [Language.Russian] = "Цветовая температура отключена",
            [Language.System] = "",
        },
        ["LockReasonSuffix"] = new()
        {
            [Language.SimplifiedChinese] = "生效",
            [Language.TraditionalChinese] = "生效",
            ...
            [Language.Russian] = " активно",
            [Language.System] = "",
        },

        ["SolarLockPaused"] = new()
        {
            [Language.SimplifiedChinese] = "调节已暂停",
            [Language.TraditionalChinese] = "調整已暫停",
            [Language.English] = "Adjustment paused",
            [Language.Japanese] = "調整は一時停止中",
            [Language.Korean] = "조정 일시 중지됨",
            [Language.German] = "Anpassung pausiert",
            [Language.French] = "Réglage en pause",
            [Language.Spanish] = "Ajuste en pausa",
            [Language.Russian] = "Настройка приостановлена",
            [Language.System] = "",
        },
        ["WlRefresh"] = new()
        {
            [Language.SimplifiedChinese] = "刷新",
            [Language.TraditionalChinese] = "重新整理",
            [Language.English] = "Refresh",
            [Language.Japanese] = "更新",
            [Language.Korean] = "새로 고침",
        ...
        ["WlHint"] = new()
        {
            [Language.SimplifiedChinese] = "勾选的程序显示时暂停调节",
            [Language.TraditionalChinese] = "勾選的程式顯示時暫停調節",
            [Language.English] = "Pause while checked apps show",
            [Language.Japanese] = "表示中は調整を一時停止",
            [Language.Korean] = "표시 중에는 조절 일시 중지",
            [Language.German] = "Pause bei angezeigten Apps",
            [Language.French] = "Pause si une app est affichée",
            [Language.Spanish] = "Pausa al mostrar la app",
            [Language.Russian] = "Пауза при показе приложения",
            [Language.System] = ""
        },
        ["WlEmpty"] = new()
        {
            [Language.SimplifiedChinese] = "打开「启用应用白名单」后扫描正在运行的程序",
            [Language.TraditionalChinese] = "開啟「啟用應用白名單」後掃描正在執行的程式",
            [Language.English] = "Turn on \"Enable whitelist\" to scan running apps",
            [Language.Japanese] = "「ホワイトリストを有効化」をオンにすると走査します",
            [Language.Korean] = "'화이트리스트 사용'을 켜면 실행 중인 앱을 검사합니다",
            [Language.German] = "„Whitelist aktivieren“ einschalten, um zu scannen",
            [Language.French] = "Activez « Activer la liste » pour analyser",
            [Language.Spanish] = "Activa «Activar la lista» para buscar apps",
            [Language.Russian] = "Включите «Включить белый список» для поиска",
            [Language.System] = ""
        },
        ["WlScanning"] = new()
        {
            [Language.SimplifiedChinese] = "正在扫描正在运行的程序…",
            [Language.TraditionalChinese] = "正在掃描正在執行的程式…",
            [Language.English] = "Scanning running apps…",
            [Language.Japanese] = "実行中のアプリを走査中…",
            [Language.Korean] = "실행 중인 앱 검사 중…",
            [Language.German] = "Laufende Apps werden gesucht…",
            [Language.French] = "Analyse des applications…",
            [Language.Spanish] = "Buscando apps en ejecución…",
            [Language.Russian] = "Поиск запущенных приложений…",
            [Language.System] = ""
        },
        ["WlSourceVisible"] = new()
        {
            [Language.SimplifiedChinese] = "当前可见",
            [Language.TraditionalChinese] = "目前可見",
            [Language.English] = "visible now",
            [Language.Japanese] = "現在表示中",
            [Language.Korean] = "현재 표시 중",
            [Language.German] = "sichtbar",
            [Language.French] = "visible",
            [Language.Spanish] = "visible",
            [Language.Russian] = "отображается",
            [Language.System] = ""
        },
        ["WlSourceMinimized"] = new()
        {
            [Language.SimplifiedChinese] = "已最小化",
            [Language.TraditionalChinese] = "已最小化",
            [Language.English] = "minimized",
            [Language.Japanese] = "最小化中",
            [Language.Korean] = "최소화됨",
            [Language.German] = "minimiert",
            [Language.French] = "réduite",
            [Language.Spanish] = "minimizada",
            [Language.Russian] = "свёрнуто",
            [Language.System] = ""
        },
        ["WlSourceTray"] = new()
        {
            [Language.SimplifiedChinese] = "任务栏托盘",
            [Language.TraditionalChinese] = "工作列匣",
            [Language.English] = "taskbar tray",
            [Language.Japanese] = "タスクトレイ",
            [Language.Korean] = "작업 표시줄 트레이",
            [Language.German] = "Infobereich",
            [Language.French] = "zone de notification",
            [Language.Spanish] = "bandeja del sistema",
            [Language.Russian] = "область уведомлений",
            [Language.System] = ""
        },
        ["WlNotRunning"] = new()
        {
            [Language.SimplifiedChinese] = "未运行",
            [Language.TraditionalChinese] = "未執行",
            [Language.English] = "not running",
            [Language.Japanese] = "未起動",
            [Language.Korean] = "실행 안 함",
            [Language.German] = "nicht gestartet",
            [Language.French] = "non lancé",
            [Language.Spanish] = "no iniciado",
            [Language.Russian] = "не запущено",
            [Language.System] = ""
        },
        ["MonitorsSettings"] = new()
        {
            [Language.SimplifiedChinese] = "显示器设置",
            [Language.TraditionalChinese] = "顯示器設定",
            [Language.English] = "Display Settings",
            [Language.Japanese] = "ディスプレイ設定",
            [Language.Korean] = "디스플레이 설정",
            [Language.German] = "Anzeigeeinstellungen",
            [Language.French] = "Paramètres d'affichage",
            [Language.Spanish] = "Configuración de pantalla",
            [Language.Russian] = "Настройки дисплея",
            [Language.System] = ""
        },
        ["MonitorsPerMonitor"] = new()
        {
            [Language.SimplifiedChinese] = "独立控制显示器",
            [Language.TraditionalChinese] = "獨立控制顯示器",
            [Language.English] = "Independent monitor control",
            [Language.Japanese] = "モニター個別制御",
            [Language.Korean] = "모니터 개별 제어",
            [Language.German] = "Monitore einzeln steuern",
            [Language.French] = "Contrôle indépendant des écrans",
            [Language.Spanish] = "Control independiente de pantallas",
            [Language.Russian] = "Независимое управление мониторами",
            [Language.System] = ""
        },
        ["MonitorsControlled"] = new()
        {
            [Language.SimplifiedChinese] = "受控显示器",
            [Language.TraditionalChinese] = "受控顯示器",
            [Language.English] = "Controlled monitors",
            [Language.Japanese] = "制御対象モニター",
            [Language.Korean] = "제어 모니터",
            [Language.German] = "Gesteuerte Monitore",
            [Language.French] = "Écrans contrôlés",
            [Language.Spanish] = "Pantallas controladas",
            [Language.Russian] = "Управляемые мониторы",
            [Language.System] = ""
        },
        ["MonitorsRename"] = new()
        {
            [Language.SimplifiedChinese] = "重命名显示器",
            [Language.TraditionalChinese] = "重新命名顯示器",
            [Language.English] = "Rename monitors",
            [Language.Japanese] = "モニター名の変更",
            [Language.Korean] = "모니터 이름 바꾸기",
            [Language.German] = "Monitore umbenennen",
            [Language.French] = "Renommer les écrans",
            [Language.Spanish] = "Renombrar pantallas",
            [Language.Russian] = "Переименовать мониторы",
            [Language.System] = ""
        },
        ["MonitorsEnabled"] = new()
        {
            [Language.SimplifiedChinese] = "启用",
            [Language.TraditionalChinese] = "啟用",
            [Language.English] = "Enabled",
            [Language.Japanese] = "有効",
            [Language.Korean] = "사용",
            [Language.German] = "Aktiviert",
            [Language.French] = "Activé",
            [Language.Spanish] = "Habilitado",
            [Language.Russian] = "Включено",
            [Language.System] = ""
        },
        ["MonitorsDisabled"] = new()
        {
            [Language.SimplifiedChinese] = "已停用",
            [Language.TraditionalChinese] = "已停用",
            [Language.English] = "Disabled",
            [Language.Japanese] = "無効",
            [Language.Korean] = "사용 안 함",
            [Language.German] = "Deaktiviert",
            [Language.French] = "Désactivé",
            [Language.Spanish] = "Deshabilitado",
            [Language.Russian] = "Отключено",
            [Language.System] = ""
        },
        ["MonitorsRenameHint"] = new()
        {
            [Language.SimplifiedChinese] = "输入新名称",
            [Language.TraditionalChinese] = "輸入新名稱",
            [Language.English] = "Enter new name",
            [Language.Japanese] = "新しい名前を入力",
            [Language.Korean] = "새 이름 입력",
            [Language.German] = "Neuen Namen eingeben",
            [Language.French] = "Saisir un nouveau nom",
            [Language.Spanish] = "Ingrese un nuevo nombre",
            [Language.Russian] = "Введите новое имя",
            [Language.System] = ""
        },
        ["MonitorsRenameBtn"] = new()
        {
        ...
        ["MonitorsInfo"] = new()
        {
            ...
            [Language.TraditionalChinese] = "顯示器資訊",
            [Language.English] = "Monitor info",
            [Language.Japanese] = "モニター情報",
            [Language.Korean] = "모니터 정보",
            [Language.German] = "Monitor-Info",
            [Language.French] = "Infos écran",
            [Language.Spanish] = "Información de pantalla",
            [Language.Russian] = "Информация о мониторах",
            [Language.System] = ""
        },
        ["DisplayDisabled"] = new()
        {
            [Language.SimplifiedChinese] = "停用",
            [Language.TraditionalChinese] = "停用",
        ...
        ["MonitorsNoDisplays"] = new()
        {
            [Language.SimplifiedChinese] = "未检测到显示器",
            [Language.TraditionalChinese] = "未偵測到顯示器",
            [Language.English] = "No monitors detected",
            [Language.Japanese] = "モニターが検出されません",
            [Language.Korean] = "모니터를 감지하지 못했습니다",
            [Language.German] = "Keine Monitore erkannt",
            [Language.French] = "Aucun écran détecté",
            [Language.Spanish] = "No se detectaron pantallas",
            [Language.Russian] = "Мониторы не обнаружены",
            [Language.System] = ""
        },
        ...
        {
            [Language.SimplifiedChinese] = "设备物理位置",
