...
public sealed class SettingsForm : Form
{
    ...
    {
        // RebuildUi clears and re-fills the items; a stale WM_REFLECT_DRAWITEM
        // (sent before the rebuild) can carry an index beyond the new item
        // count. Guard both ends so that cannot throw ArgumentOutOfRange.
