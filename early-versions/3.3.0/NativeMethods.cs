...
public static class NativeMethods
{
    ...
    [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
    public static extern bool AppendMenu(IntPtr hMenu, uint uFlags, uint uIDNewItem, IntPtr lpNewItem);
    ...
    // MenuInfo background brush: lets us paint the whole popup menu
    // (including padding and the area below the last item, which
    // owner-draw does not cover) in the theme background color.
