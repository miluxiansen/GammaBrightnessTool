...
public static class Localization
{
    private static readonly Dictionary<string, Dictionary<Language, string>> _strings = new()
    {
        ...
        ["HotkeyConflict"] = new()
        {
            ...
            [Language.Korean] = "이 단축키는 이미 사용 중입니다",
        ...
        ["ClearAllHotkeysDone"] = new()
        {
            ...
            [Language.Korean] = "모든 단축키가 지워졌습니다",
        ...
        ["ResetConfirm"] = new()
        {
            ...
            [Language.Korean] = "모든 설정을 기본값으로 초기화할까요?",
        ...
        ["ResetDone"] = new()
        {
            ...
            [Language.Korean] = "설정이 기본값으로 초기화되었습니다",
